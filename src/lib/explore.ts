...
export const MOCK_ONLINE_VENDORS: ExploreVendor[] = [
  ...
  },
  {
    ...
    category: "baby_early_years",
    delivery_type: "online",
    age_relevance: "expecting,0-6m,6-24m,2-5y",
    priority_weight: 85,
  ...
  },
  {
    ...
    category: "baby_early_years",
    delivery_type: "online",
    age_relevance: "0-6m,6-24m,2-5y,5-16y",
    priority_weight: 75,
  ...
  },
  {
    ...
    delivery_type: "online",
    age_relevance: "expecting,0-6m,6-24m,2-5y,5-16y",
    priority_weight: 60,
...
export const AGE_FILTER_OPTIONS = [
  ...
  { key: "0-6m", label: "Newborns (0-6 months)" },
  { key: "6-24m", label: "Toddlers (6-24 months)" },
  { key: "2-5y", label: "Pre-school (2-5 years)" },
  { key: "5-16y", label: "School age (5-16 years)" },
] as const;
