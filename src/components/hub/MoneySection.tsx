    ...
    <section className="bg-[#2A2A2A] text-white py-24 md:py-32">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] font-bold leading-[1.2] mt-4 lg:whitespace-nowrap">
            Money &amp; Financial Support
          </h2>
          <p className="font-body text-[1.1rem] text-white/70 mt-4 leading-relaxed max-w-[600px] mx-auto">
